...
object SparkScalaBitcoinGraphExportToGEXF {
   def main(args: Array[String]): Unit = {
	...
	jobExportToGEXP(sc,hadoopConf,args(0),args(1),args(2))
	sc.stop()
      }

 def jobExportToGEXP(sc: SparkContext, hadoopConf: Configuration, inputFile: String, outputFile: String, account: String): Unit = {
